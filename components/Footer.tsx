    ...
    <footer className="bg-[#0f1f2e] text-white mt-auto">
      ...
      <div className="container mx-auto px-4 py-8 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-0 lg:gap-8 text-sm">
          ...
          <div className="border-b border-gray-800 lg:border-none">
            ...
            >
              <span className="flex items-center"><span className="text-[#EE6348] mr-2">›</span> MY ACCOUNT</span>
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openSections['account'] ? 'max-h-[300px] opacity-100 mb-4' : 'max-h-0 opacity-0 lg:max-h-full lg:opacity-100 lg:mb-0'}`}>
              <ul className="space-y-3 text-gray-400">
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('account', 'dashboard')}>› My Account</li>
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('account', 'orders')}>› Orders</li>
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('account', 'addresses')}>› Addresses</li>
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('cart')}>› Shopping Cart</li>
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('wishlist')}>› Wishlist</li>
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('track-order')}>› Track Your Order</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-b border-gray-800 lg:border-none">
            ...
            >
              <span className="flex items-center"><span className="text-[#EE6348] mr-2">›</span> INFORMATION</span>
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openSections['info'] ? 'max-h-[300px] opacity-100 mb-4' : 'max-h-0 opacity-0 lg:max-h-full lg:opacity-100 lg:mb-0'}`}>
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('page', 'rental-policy')}>› Rental Policy</li>
                ...
                <li className="hover:text-[#EE6348] cursor-pointer transition" onClick={() => onNavigate('page', 'about-us')}>› About Us</li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-b border-gray-800 lg:border-none">
            ...
            >
              <span className="flex items-center"><span className="text-[#EE6348] mr-2">›</span> FOLLOW US</span>
            ...
            <div className={`overflow-hidden transition-all duration-300 ease-in-out ${openSections['follow'] ? 'max-h-[300px] opacity-100 mb-4' : 'max-h-0 opacity-0 lg:max-h-full lg:opacity-100 lg:mb-0'}`}>
              ...
              <h4 className="font-bold text-lg mb-4 flex items-center">
                <span className="text-[#EE6348] mr-2">›</span> PAYMENT METHODS
              </h4>
      ...
      <div className="bg-[#0b141b] py-6 border-t border-gray-800 text-xs text-gray-500">
        <div className="container mx-auto px-4 text-center">
          <p>© 2025 Veena Collections. All Rights Reserved. Design By <a href="https://sathishkaruppaiyan.in" target="_blank" rel="noopener noreferrer" className="text-[#EE6348] hover:text-white transition">Sathish Karuppaiyan</a></p>
        </div>
      </div>
    </footer>
  );
